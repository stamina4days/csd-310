...
-- create movies_user using the authentication plugin supported by MySQL 8.0.46
CREATE USER 'movies_user'@'localhost'
    IDENTIFIED WITH caching_sha2_password BY 'popcorn';
...
-- create the film table and set the foreign keys
CREATE TABLE film (
